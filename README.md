...
В командной строке натс-сервер уже добавлен в сервер по умолчанию, поэтому можно сразу пользоваться без лишних параметром. Например, откроем в одном терминале. 
